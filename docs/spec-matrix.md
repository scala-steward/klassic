...
- a first native compiler vertical slice for Linux x86_64 ELF64 executables,
  ...
  call-site buffers, function value aliases, static record fields, and direct
  static-list `head` lookups preserving those runtime return hints, immediate
  calls on conditional function values,
