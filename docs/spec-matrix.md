...
- a first native compiler vertical slice for Linux x86_64 ELF64 executables,
  ...
  recursive functions, including self-calls that rewrite those buffered values
