...
- a first native compiler vertical slice for Linux x86_64 ELF64 executables,
  ...
  call-site inlined unannotated pass-through and string-literal concatenation `def`s over runtime `String` / `List<String>` values,
