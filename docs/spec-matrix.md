...
- a first native compiler vertical slice for Linux x86_64 ELF64 executables,
  ...
  annotated runtime `String` parameters in scalar-returning recursive functions
  whose self-calls pass the string through unchanged,
