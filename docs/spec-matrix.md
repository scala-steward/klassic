...
- a first native compiler vertical slice for Linux x86_64 ELF64 executables,
  ...
  static/runtime string `replaceAll` with static patterns and runtime replacement strings,
